...
const jawabanBenar = "Di Goreng";

const image = {
  id: uuidv4(),
  content: NasiGoreng,
  soal: "Dari gambar di atas, teknik pengolahan yang tepat adalah",
};
  ...
  useEffect(() => {
    ...
    const newColumns = {
      ...
      [initialGambarColumnId]: {
        ...
        items: [{ id: uuidv4(), content: image.content, soal: image.soal }],
      },
